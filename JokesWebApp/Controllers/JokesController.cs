...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            if (_context.Joke == null) return Problem("Entity set 'ApplicationDbContext.Joke'  is null.");

            return View("Index",
                await _context.Joke
                .Where(s => s.JokeQuestion.Contains(SearchPhrase))
                .ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokeAnswer,UserEmail")] Joke joke)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if(joke.UserEmail !=  user) { return Forbid(); }
            return View(joke);
        }
